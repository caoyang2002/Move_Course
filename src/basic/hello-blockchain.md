...
>![WARNING] 警告
> 这里需要提前告诉大家，在 Move-Aptos 中，是不支持 Unicode 编码的！！！仅仅支持 ASCII 编码，所以，如果你想在 Move 中写中文，那么，请使用英文或者拼音代替。

相信所有入门开发的同学，第一句代码一定是 “Hello，world！”，但是由于区块链开发的特殊（叛逆）性，一些项目会使用 “Hello，Blockchain！”
